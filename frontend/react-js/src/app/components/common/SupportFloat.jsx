...
import { MessageCircle } from 'lucide-react'; // برای آیکون پیش‌فرض یا دکمه بازشو (اختیاری)

const SupportFloat = () => {
  return (
    <div className="fixed bottom-6 left-6 z-50 flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      
      {/* دکمه تلگرام */}
      <a
        href="https://t.me/printoo24" // آیدی تلگرام خود را جایگزین کنید
        target="_blank"
        rel="noreferrer"
