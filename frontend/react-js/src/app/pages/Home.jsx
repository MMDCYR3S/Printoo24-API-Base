  ...
  return (
    <>
      ...
      {/* <Helmet> */}
        ...
        <meta name="description" content="سامانه آنلاین سفارش چاپ بنر، کارت ویزیت و تراکت با تحویل فوری در سلیمانیه و اربیل." />
      {/* </Helmet> */}
    ...
    <section className="container mx-auto px-4">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {features.map((item) => (
          ...
          >
            <div className={`p-4 rounded-2xl mb-4 border ${item.color} group-hover:scale-110 transition-transform duration-300`}>
              {item.icon}
            </div>
  ...
  <section className="container mx-auto px-4">
    <div className="relative rounded-3xl overflow-hidden bg-slate-800 h-[200px] md:h-[250px] shadow-xl flex items-center p-8 md:p-12">
        <div className="absolute inset-0 opacity-30">
            <img src="https://via.placeholder.com/1200x400" className="w-full h-full object-cover grayscale" alt="Pattern" />
        </div>
        <div className="relative z-10 max-w-2xl">
            <div className="badge badge-warning font-bold mb-3">پیشنهاد ویژه همکاران</div>
            <h2 className="text-2xl md:text-4xl font-black text-white mb-2">تخفیف ۱۰٪ روی سفارش‌های لارج فرمت</h2>
            <p className="text-slate-300 mb-6">فقط تا پایان هفته جاری، برای سفارش‌های بالای ۱۰۰ متر مربع.</p>
        </div>
    </div>
  </section>
);
