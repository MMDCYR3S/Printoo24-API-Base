...
const TutorialListPagePublic = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-7xl" dir="rtl">
      <SEO 
        title="فێرکاری بەکارهێنان" 
        description="فێری بەکارهێنانی وێبسایتی Printoo24 ببە. شێوازی داواکردنی بەرهەم، بارکردنی فایل، هەڵبژاردنی تایبەتمەندییەکان، ژمێرکردنی نرخ و تەواوکردنی داواکارییەکان بە ئاسانی فێربە."
        keywords="فێرکاری وێبسایت, بەکارهێنانی Printoo24, چۆنیەتی داواکردنی چاپ, بارکردنی فایل, هەژمارکردنی نرخ, داواکاری ئۆنلاین, فێرکاری کڕین, وێبسایتی چاپ, Printoo24 tutorial, پرینتۆ24"
      />
