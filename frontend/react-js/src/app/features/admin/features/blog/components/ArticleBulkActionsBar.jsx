...
import { Trash2, CheckCircle, Clock, Archive, X } from 'lucide-react';

const ArticleBulkActionsBar = ({ selectedCount, onClear, onDelete, onStatusChange }) => {
  return (
    <AnimatePresence>
      {selectedCount > 0 && (
        <motion.div 
        ...
        >
          <div className="flex items-center gap-3 border-l border-white/10 pl-4">
            ...
            <span className="text-sm font-medium">مقاله انتخاب شد</span>
          </div>
          ...
          <div className="flex items-center gap-1">
            ...
            <button 
                ...
                className="btn btn-ghost btn-sm text-slate-300 hover:bg-white/10 gap-2 font-normal"
            >
                <Clock size={18}/>
...
export default ArticleBulkActionsBar;   