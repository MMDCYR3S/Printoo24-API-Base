...
class OrderQuerySet(models.QuerySet):
    ...
    def get_full_order_detail_for_admin(self, order_id: int):
        """
        دریافت سوپر-دیتا برای پنل مدیریت.
        شامل: آیتم‌ها، فایل‌ها، سند مالی، گزارشات چاپ و مرسولات.
        """
        from ..models import (
            OrderItem, OrderItemFile, OrderCostSheet, OrderCostReport, 
            OrderCostItem, OrderPrintReport, OrderPrintItem, OrderShipment
        )
