# Generated by Django 5.2.9 on 2025-12-31 16:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='cart',
            name='session_key',
            field=models.CharField(blank=True, db_index=True, help_text='شناسه یکتا برای کاربران مهمان (معمولاً Session ID جنگو یا UUID)', max_length=40, null=True, verbose_name='شناسه نشست'),
        ),
